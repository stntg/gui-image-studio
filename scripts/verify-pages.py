...
def main():
    ...
    if len(sys.argv) != 2:
        ...
        print("Example: python verify-pages.py https://yourusername.github.io/gui-image-studio/")
        sys.exit(1)
    ...
    if success:
        ...
        print("📖 Check the Actions tab in your GitHub repository for deployment status.")

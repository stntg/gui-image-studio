...
class ContrastSaturationDemo:
    ...
    def setup_ui(self):
        ...
        # Title
        title_label = ctk.CTkLabel(self.root, text="Contrast & Saturation Adjustment", 
        ...
        # Image selection
        ctk.CTkLabel(controls_frame, text="Image:", 
                    font=ctk.CTkFont(size=14, weight="bold")).pack(pady=(10, 5))
        
        self.image_var = tk.StringVar(value="colorful.png")
        image_combo = ctk.CTkComboBox(controls_frame, variable=self.image_var,
                                     values=["colorful.png", "icon.png", "logo.png"],
                                     command=self.on_image_change)
        image_combo.pack(pady=(0, 20))
        
        # Contrast control
        ctk.CTkLabel(controls_frame, text="Contrast:", 
                    font=ctk.CTkFont(size=14, weight="bold")).pack(pady=(10, 5))
        
        self.contrast_var = tk.DoubleVar(value=1.0)
        contrast_slider = ctk.CTkSlider(controls_frame, from_=0.1, to=3.0, 
        ...
        # Saturation control
        ctk.CTkLabel(controls_frame, text="Saturation:", 
                    font=ctk.CTkFont(size=14, weight="bold")).pack(pady=(10, 5))
        
        self.saturation_var = tk.DoubleVar(value=1.0)
        saturation_slider = ctk.CTkSlider(controls_frame, from_=0.0, to=3.0, 
        ...
        # Additional controls
        ctk.CTkLabel(controls_frame, text="Additional Effects:", 
                    font=ctk.CTkFont(size=14, weight="bold")).pack(pady=(10, 5))
        
        self.grayscale_var = tk.BooleanVar()
        grayscale_check = ctk.CTkCheckBox(controls_frame, text="Grayscale",
                                         variable=self.grayscale_var,
                                         command=self.update_image)
        grayscale_check.pack(pady=5)
        
        # Tint controls
        ctk.CTkLabel(controls_frame, text="Tint Intensity:", 
                    font=ctk.CTkFont(size=12)).pack(pady=(10, 5))
        
        self.tint_var = tk.DoubleVar(value=0.0)
        tint_slider = ctk.CTkSlider(controls_frame, from_=0.0, to=1.0, 
        ...
        # Reset button
        reset_btn = ctk.CTkButton(controls_frame, text="Reset All", 
                                 command=self.reset_values)
        reset_btn.pack(pady=20)
        
        # Presets
        ctk.CTkLabel(controls_frame, text="Presets:", 
        ...
        for name, values in presets:
            btn = ctk.CTkButton(controls_frame, text=name, width=100,
...
def main():
    ...
    try:
        ...
        print("CustomTkinter not installed. Please install with: pip install customtkinter")
    except Exception as e:

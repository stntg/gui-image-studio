...
class ImageDisplayDemo:
    ...
    def create_tkinter_demo(self):
        ...
        # Load button
        load_btn = ttk.Button(main_frame, text="Load Embedded Images File", 
    ...
    def create_customtkinter_demo(self):
        ...
        # Load button
        load_btn = ctk.CTkButton(main_frame, text="Load Embedded Images File", 
                                command=self.load_embedded_file)
        load_btn.pack(pady=10)
    ...
    def display_images(self):
        ...
        try:
            ...
            scrollbar = ttk.Scrollbar(self.images_frame, orient="vertical", command=canvas.yview)
            ...
            for theme, theme_images in images_dict.items():
                # Theme header
                theme_label = ttk.Label(scrollable_frame, text=f"Theme: {theme}", 
                                       font=("Arial", 12, "bold"))
                theme_label.grid(row=row, column=0, columnspan=3, sticky="w", pady=(10, 5))
                row += 1

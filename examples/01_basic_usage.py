...
def tkinter_example():
    ...
    status_label = tk.Label(root, text="Welcome to Tkinter Basic Example", 
                           font=("Arial", 12, "bold"))
    ...
    main_button = tk.Button(buttons_frame, image=button_image, text="Click Me", 
                           compound=tk.CENTER, command=on_button_click)
    main_button.pack(side=tk.LEFT, padx=5)
    
    # Additional buttons to demonstrate functionality
    change_button = tk.Button(buttons_frame, text="Change Image", 
                             command=load_different_image)
    change_button.pack(side=tk.LEFT, padx=5)
    
    reset_button = tk.Button(buttons_frame, text="Reset Image", 
                            command=reset_image)
...
def customtkinter_example():
    ...
    try:
        ...
        # Status label for feedback
        status_label = ctk.CTkLabel(root, text="Welcome to CustomTkinter Basic Example", 
        ...
        # Create widgets
        icon_label = ctk.CTkLabel(root, image=icon_image, text="Basic Icon", compound=tk.TOP)
        ...
        # Main button with image
        main_button = ctk.CTkButton(buttons_frame, image=button_image, text="Click Me", 
        ...
        change_button = ctk.CTkButton(button_grid, text="Change Image", 
                                     command=load_different_image, width=120)
        change_button.grid(row=0, column=0, padx=5, pady=5)
        
        reset_button = ctk.CTkButton(button_grid, text="Reset Image", 
                                    command=reset_image, width=120)
        reset_button.grid(row=0, column=1, padx=5, pady=5)
        
        appearance_button = ctk.CTkButton(button_grid, text="Toggle Theme", 
                                         command=toggle_appearance, width=120)
        ...
        instructions = ctk.CTkLabel(root, 
                                   ...
                                   justify=tk.LEFT, font=ctk.CTkFont(size=11))

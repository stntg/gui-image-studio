...
This creates various types of images including static icons, animated GIFs, and themed variants.
"""
...
def create_basic_icon(filepath):
    ...
    # Base
    draw.rectangle([10, 35, 54, 54], fill=(100, 150, 200, 255), outline=(50, 100, 150, 255), width=2)
    # Roof
    draw.polygon([(32, 10), (8, 35), (56, 35)], fill=(150, 100, 50, 255), outline=(100, 50, 25, 255))
    # Door
    draw.rectangle([28, 42, 36, 54], fill=(80, 40, 20, 255))
    # Windows
    draw.rectangle([15, 40, 22, 47], fill=(200, 200, 100, 255), outline=(150, 150, 50, 255))
    draw.rectangle([42, 40, 49, 47], fill=(200, 200, 100, 255), outline=(150, 150, 50, 255))
...
def create_themed_icon(filepath, theme):
    ...
    draw.ellipse([center[0] - outer_radius, center[1] - outer_radius, 
                  center[0] + outer_radius, center[1] + outer_radius], fill=primary, outline=secondary)
    
    # Draw inner circle
    draw.ellipse([center[0] - inner_radius, center[1] - inner_radius, 
                  center[0] + inner_radius, center[1] + inner_radius], fill=accent)
    
    # Draw center hole
    draw.ellipse([center[0] - 8, center[1] - 8, center[0] + 8, center[1] + 8], fill=(0, 0, 0, 0))
...
def create_button_icon(filepath, text, theme="default"):
    ...
    draw.rounded_rectangle([2, 2, 78, 30], radius=5, fill=bg_color, outline=border_color, width=2)
...
def create_shape_icon(filepath, shape):
    ...
    if shape == "circle":
        draw.ellipse([12, 12, 52, 52], fill=(255, 100, 100, 255), outline=(200, 50, 50, 255), width=3)
    elif shape == "square":
        draw.rectangle([12, 12, 52, 52], fill=(100, 255, 100, 255), outline=(50, 200, 50, 255), width=3)
    elif shape == "triangle":
        draw.polygon([(32, 12), (12, 52), (52, 52)], fill=(100, 100, 255, 255), outline=(50, 50, 200, 255))

...
latex_documents = [
    (master_doc, 'GUIImageStudio.tex', 'GUI Image Studio Documentation',
     'GUI Image Studio Contributors', 'manual'),
]
...
man_pages = [
    (master_doc, 'gui-image-studio', 'GUI Image Studio Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'GUIImageStudio', 'GUI Image Studio Documentation',
     author, 'GUIImageStudio', 'Professional image processing and GUI design tool.',
     'Miscellaneous'),
]
